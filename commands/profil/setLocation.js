...
exports.exec = async (Bastion, message, args) => {
  ...
  await message.channel.send({
    embed: {
      ...
      title: 'Yer Ayarlandı',
      description: `${message.author.tag}, yerinizi değiştirdiniz ${args.location}. Eğer ek getirmediyseniz cümle hatası olur ve bunu hiç istemeyiz. "Örn: Ankara'da yaşıyor." 'da ekinide yazdım.`
    }
  }).catch(e => {
    Bastion.log.error(e);
  });
