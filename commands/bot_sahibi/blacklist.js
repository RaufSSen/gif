...
exports.help = {
  name: 'blacklist',
  description: 'Birisini karalisteye at bu sayede artık BOT komutlarını kullanamıyacak.',
  botPermission: '',
  userTextPermission: '',
  userVoicePermission: '',
  usage: 'karaliste <USER_ID> [--remove]',
  example: [ 'karaliste @user#001 224433119988776655', 'blacklist @user#001 --remove' ]
};
