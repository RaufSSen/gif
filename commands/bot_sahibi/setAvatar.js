...
exports.exec = async (Bastion, message, args) => {
  ...
  await message.channel.send({
    embed: {
      ...
      description: `${Bastion.user.username}' avatarını değiştirdi!`
    }
  }).catch(e => {
    Bastion.log.error(e);
  });
...
exports.help = {
  ...
  userTextPermission: '',
  userVoicePermission: '',
  usage: 'avatarayarla <avatar_url>',
  example: [ 'avatarayarla https://deneme.com/avatar.jpeg' ]
};
