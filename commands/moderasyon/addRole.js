...
exports.help = {
  name: 'addRole',
  description: 'Seçtiğin kişiye rol vermene yarar.',
  botPermission: 'MANAGE_ROLES',
  userTextPermission: 'MANAGE_ROLES',
  userVoicePermission: '',
  usage: 'rolekle [@kullanıcı] <Rol Adı>',
  example: [ 'rolekle @user#001 Rol Adı', 'rolekle Rol Adı' ]
};
