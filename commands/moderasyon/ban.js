...
exports.help = {
  name: 'ban',
  description: 'Kullanıcıyı banlar ve son 7 günde yazdığı tüm mesajları siler.',
  botPermission: 'BAN_MEMBERS',
  userTextPermission: 'BAN_MEMBERS',
  userVoicePermission: '',
  usage: 'ban <@kullanıcı | kullanıcı_ID> -r [Amaç]',
  example: [ 'ban @test#001 -r Spamm.', 'ban 167147569575323761 -r spammer.' ]
};
