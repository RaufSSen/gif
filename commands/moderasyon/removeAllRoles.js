...
exports.help = {
  name: 'removeAllRoles',
  description: 'Seçtiğin kullanıcının tüm rollerini siler.',
  botPermission: 'MANAGE_ROLES',
  userTextPermission: 'MANAGE_ROLES',
  userVoicePermission: '',
  usage: 'tumrolsil [ @KULLANICI | KULLANICI_ID ]',
  example: [ 'tumrolsil @user#0001', 'tumrolsil 282424753565461211', 'tumrolsil' ]
};
