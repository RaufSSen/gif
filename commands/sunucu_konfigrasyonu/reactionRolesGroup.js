...
exports.exec = async (Bastion, message, args) => {
  ...
  let reactionRolesMessage = await message.channel.send({
    embed: {
      color: Bastion.colors.BLUE,
      title: args.title && args.title.length ? args.title.join(' ') : 'Alttaki Emojiye Tıklayarak Rolünü kap!',
      description: body,
      footer: {
        text: `${args.exclusive ? 'Mutually Exclusive' : ''} Alttaki Emojiye Tıklayarak Rolünü kap • Emojiye basmaktan vazgeçersen rolün silinir.`
      }
    }
  });
