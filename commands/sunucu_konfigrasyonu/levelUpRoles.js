...
exports.exec = async (Bastion, message, args) => {
  if (args.level && args.add) {
    ...
    if (!roleModel || !roleModel.length) {
      color = Bastion.colors.RED;
      description = 'Sunucuda Seviye Rolleri Yok.';
    }
    else {
      let levelUpRoles = {};
      ...
      description = 'Bu sunucuda seviye atladıklarında kullanıcılara eklenecek roller.';
    }
...
exports.help = {
  ...
  userVoicePermission: '',
  usage: 'seviyeRolleri [ SEVIYE --add ROLE_ID ] [ LEVEL --remove ]',
  example: [ 'seviyeRolleri', 'seviyeRolleri 10 --add 443322110055998877', 'seviyeRolleri 10 --remove' ]
};
