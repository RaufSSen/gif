...
exports.exec = async (Bastion, message, args) => {
  ...
  await message.channel.send({
    embed: {
      ...
      description: `<@${args.id}> adlı kullanıcı **${awardedXP}** seviye puanı ile ödüllendirildi.`
    }
  }).catch(e => {
    Bastion.log.error(e);
  });
...
exports.help = {
  ...
  userVoicePermission: '',
  usage: 'xpver <@KULLANICI | ID> <-n POINTS>',
  example: [ 'xpver @test#0001 -n 100', 'giveXP 242621467230268813 -n 150' ]
};
