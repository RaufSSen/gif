...
module.exports = async message => {
  try {
    ...
    let currentLevel = Math.floor(1 * Math.sqrt(guildMemberModel.dataValues.experiencePoints + 1)); 
        ...
        if (guildModel.dataValues.levelUpMessages) {
          ...
          message.channel.send({
            embed: {
              ...
              thumbnail: {
                url: `https://dummyimage.com/250/ff0048/ffffff.png&text=${currentLevel}`
              },
              fields: [
                {
                  name: `${message.author.tag}  ${currentLevel} seviyesine yükseldi!`,
                  value: '\u200B'
                }
              ]
            }
